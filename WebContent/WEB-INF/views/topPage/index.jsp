    ...
    <c:param name="content">
        ...
        <c:if test="${get4getMyDraftsCnt != 0 && get4getManagerReviewsCnt != 0}">
            <div class="ui error message">
                ...
                </a><br> <a href="<c:url value='/reviews/manager' />">課長承認待ちの日報が<c:out
                    value="${get4getManagerReviewsCnt}"/>件あります。
            </a>
            </div>
        </c:if>
        ...
        <c:if test="${get4getMyDraftsCnt != 0 && get4getDirectorReviewsCnt != 0}">
            <div class="ui error message">
                ...
                <a href="<c:url value='/drafts' />">下書きのメモが<c:out value="${get4getMyDraftsCnt}"/>件あります。
                </a><br> <a href="<c:url value='/reviews/director' />">部長承認待ちの日報が<c:out
                    value="${get4getDirectorReviewsCnt}"/>件あります。
            </a>
            </div>
        </c:if>
        ...
        <c:if test="${get4getManagerReviewsCnt != 0 && get4getMyDraftsCnt == 0}">
            <div class="ui error message">
                ...
                <a href="<c:url value='/reviews/manager' />">課長承認待ちの日報が<c:out
                        value="${get4getManagerReviewsCnt}"/>件あります。
                </a>
            </div>
        </c:if>
        ...
        <c:if test="${get4getDirectorReviewsCnt != 0 && get4getMyDraftsCnt == 0}">
            <div class="ui error message">
                ...
                <a href="<c:url value='/reviews/director' />">部長承認待ちの日報が<c:out
                        value="${get4getDirectorReviewsCnt}"/>件あります。
                </a>
            </div>
        </c:if>
        ...
        <div class="ui teal image label">
            My swatches
            <div class="detail">${getMyIdeasCnt}</div>
        </div>

        <a href="<c:url value='/ideas' />" class="ui image label"> All swatches <span
