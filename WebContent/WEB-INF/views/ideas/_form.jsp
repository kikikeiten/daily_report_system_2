...
<div class="field">
    ...
    <input type="date" name="createdDate"
           value="<fmt:formatDate value='${idea.createdDate}' pattern='yyyy / MM / dd' />"/>
</div>
...
<div class="field">
    <label for="title">Title</label> <input type="text" name="title" value="${idea.title}"/>
</div>

<div class="field">
    <label for="content">Content</label>
    <textarea name="content" rows="10" cols="50">${idea.content}</textarea>
</div>
