...
<c:import url="/WEB-INF/views/layout/app.jsp">
    <c:param name="content">
        ...
        <div class="ui raised very padded text container segment">
            ...
            <div class="ui image label">
                出勤日
                <div class="detail"><c:out value="${join.join_date}"/>
                </div>
            </div>
            <div class="ui image label">
                出勤時刻
                <div class="detail"><c:out value="${join.punch_in}"/>
                </div>
            </div>
            <form class="ui fluid form" method="POST" action="<c:url value='/punchout/update' />">
                <div class="fields">
                    <div class="four wide field">
                        <label for="punchOutHour">
                            時
                        </label>
                        <input type="text" name="punchOutHour" placeholder="00"/>
                    </div>
                    <div class="four wide field">
                        <label for="punchOutMinute">
                            分
                        </label>
